export default {
  ...
  CURRENT_PASSWORD_NOT_MATCH: 'New Password Should Be Different From Your Old Password.',
  ...
  SEND_EMAIL_VERIFICATION: 'Please Check Your Email.',
  ...
  PASSWORD_LINK_SENT: 'Please Check Your Email.',
  ...
  LINK_EXPIRE: 'Reset Password Link Inactive Since 12 Hours Have Gone By! Please Reset Your Password Again',
  ...
  THUMBNAIL_CREATED_SUCCESSFULLY: 'Thumbnail Created Successfully.',
  ...
  CHILD_CATEGORY_UPDATE_EXIST: 'Child Category Is Already Available In The System',
  ...
  CUSTOMER_STATUS_INACTIVE: 'Customer Can\'T Be Deactivated As Order Is In Process',
  ...
  */
  ...
  FIRST_NAME_EXCEEDS_MAX_LENGTH: 'First name exceeds maximum length (255 characters).',
  LAST_NAME_EXCEEDS_MAX_LENGTH: 'Last name exceeds maximum length (255 characters).',
  EMAIL_EXCEEDS_MAX_LENGTH: 'Email exceeds maximum length (255 characters).',
  MOBILE_EXCEEDS_MAX_LENGTH: 'Mobile exceeds maximum length (50 characters).',
  CONTACT_CREATED_SUCCESS: 'Contact Created Successfully',
  CONTACT_US_LIST: 'Contact Us List',

  /**
   * Ready Made App Message
   */
  READY_MADE_APP_PUBLISHED: 'Ready Made App Published Successfully',
